...
# FUNCTION
def user_report():
    pregnancies = st.sidebar.slider('Pregnancy Occurrences', 0, 17, 3)
    glucose = st.sidebar.slider('Blood Glucose Level (mg/dl)', 0, 200, 120)
    bp = st.sidebar.slider('Blood Pressure (mmHg)', 0, 122, 70)
    ...
    age = st.sidebar.slider('Age (yrs)', 21, 88, 33)
